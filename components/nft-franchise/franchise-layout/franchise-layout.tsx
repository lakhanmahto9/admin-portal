...
import FranchiseSidebar from "../franchise-sidebar/franchiseSidebar";
import FranchiseHeader from "../franchise-header/franchiseHeader";
...
const FranchiseLayout: React.FC<ArtLayoutProps> = ({ children }) => {
