...
export const BuyerProfile: React.FC = () => {
  ...
  const profile = useSelector(
    (state: any) => state.buyerprofile?.data?.phbuyer
  );
  const profile1 = useSelector(
    (state: any) => state.buyerprofile?.data?.phbuyer1
  );
        ...
        <div className="w-full h-[88%] overflow-y-scroll flex flex-col md:flex-row p-2 md:p-7 gap-4">
          <div className="w-full md:w-[40%] flex flex-col gap-4">
            <div
              className={`w-full h-auto md:h-1/2 border rounded-lg p-2 ${
                isDarkEnabled ? "bg-[#040836]" : "bg-[#ebf6fd]"
            ...
            <div
              className={`hidden md:block ${
                isDarkEnabled ? "bg-[#040836]" : "bg-[#ebf6fd]"
              } relative w-full h-1/2 border rounded-lg bg-[#ebf6fd] px-16 py-2`}
            >
              {!profile?.idCard ? (
          ...
          <div
            className={`w-full md:w-[60%] ${
              isDarkEnabled ? "bg-[#040836] border" : "bg-[#ebf6fd]"
          ...
          >
            ...
            <div className="flex gap-4 justify-between md:justify-start">
              ...
              <p className="text-lg text-[#6a6a6b] break-all">
                {profile?.email}
              </p>
            </div>
            <div className="flex gap-4 justify-between md:justify-start">
