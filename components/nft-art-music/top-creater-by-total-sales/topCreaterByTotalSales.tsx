...
const TopCreatorsByTotalSale: React.FC = () => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get<TopCreatorsResponse>(
          `${BASE_URL}/admin/top-creators-on-the-basis-of-number-of-sale-and-total-revenue`
        );
  ...
  const filteredCreators = topCreators.filter(
    (creator) =>
...
export default TopCreatorsByTotalSale;
